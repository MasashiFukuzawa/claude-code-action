...
describe("TaskAnalyzer", () => {
  ...
  it("should return placeholder analysis results with language detection", () => {
    ...
    expect(japaneseResult.reason).toMatch(
      /Analysis not implemented yet \(detected: Japanese\)/,
    );
    ...
    expect(englishResult.reason).toMatch(
      /Analysis not implemented yet \(detected: non-Japanese\)/,
    );
